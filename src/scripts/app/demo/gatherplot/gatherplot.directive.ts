...
//        this.zone.run();
    ...
    public drawHeatMapLegends() {
        ...
        g.append("text")
            ...
            .attr("dy", ".35em")
            .style("text-anchor", "middle")
            .text(d3.precisionRound(colorDomain[0], 1));
        ...
        g.append("text")
            ...
            .attr("dy", ".35em")
            .style("text-anchor", "middle")
            .text(d3.precisionRound(colorDomain[1], 1));
